  ...
  return (
    <div className="bg-slate-500 text-white">
      <div className="bg-[#000000] text-white pt-[100px] px-[20px]">
        ...
        <div className="relative mt-[50px] mx-[-20px] px-[0px]">
          <div className="hidden sm:block bg-[#9B06EA] sm:h-[40px]">
          </div>
          <div className="sm:mt-[-70px]">
            <div className="flex justify-evenly sm:justify-center">
              <div className="text-center">
                <div className="data-box bg-[#000000] mr-[5px] text-center rounded-2xl border text-[40px] sm:text-[50px] w-[80px] sm:w-[100px] md:w-[130px] sm:h-[100px] md:h-[110px] flex justify-center items-center  font-bold border-blue-700">
                  <span>8</span>
                </div>
                <span className="text-center">Days</span>
              </div>
              <div className="text-center ml-[20px]">
                <div className="data-box bg-[#000000] mr-[5px] text-center rounded-2xl border text-[40px] sm:text-[50px] w-[80px] sm:w-[100px] md:w-[130px] md:h-[110px] flex justify-center items-center sm:h-[100px] font-bold border-blue-700">
                  <span>21</span>
                </div>
                <span className="text-center">Hours</span>
              </div>
              <div className="data-box text-center ml-[20px]">
                <div className="bg-[#000000] mr-[5px] text-center rounded-2xl border text-[40px] sm:text-[50px] w-[80px] sm:w-[100px] md:w-[130px]  md:h-[110px] flex justify-center items-center sm:h-[100px] font-bold border-blue-700">
                  <span>51</span>
                </div>
      ...
      <div className="md:mt-[-66px]">
        <div
          ...
          className="py-[100px] md:pb-[50px] md:pt-[0px] bg-cover px-[20px] md:px-[0px]"
        >
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="mt-[100px] flex justify-between flex-col md:items-center  md:flex-row px-[20px]">
              ...
              <div className="text-center"><p className="w-[250px] md:w-[200px] mt-[10px]">Mint or BUY LSC NFT in the secondary market</p></div>
              </div>
              <div className="flex justify-center md:block">
                <img className="w-[80px] h-[40px] rotate-90 md:rotate-0 mt-[20px] mb-[40px] md:md-[0px] md:mb-[0px]" src={arrow} alt="" />
              </div>
              <div>
              <div
                style={{
              ...
              <div className="text-center"><p className="w-[250px] md:w-[200px] md:ml-[50px] mt-[10px]">Hold the NFT and participate automatically in weekly giveaways</p></div>
              </div>
              <div className="flex justify-center md:block">
                <img className="w-[80px] h-[40px] rotate-90 md:rotate-0 mt-[20px] mb-[40px] md:md-[0px] md:mb-[0px]" src={arrow} alt="" />
              </div>
             ...
             <div
              ...
              >
                ...
                <div className="flex flex-col items-center">
                  <img src={buy} alt="" />
                  <p className="text-[20px] lg:text-[30px] font-bold">Receive Rewards</p>
                </div>
              </div>
              <div className="text-center"><p className="w-[250px] md:w-[200px] md:ml-[50px] mt-[10px]">Receive rewards weekly in Vulcan and other</p></div>
             </div>
            </div>
          </div>
        </div>
